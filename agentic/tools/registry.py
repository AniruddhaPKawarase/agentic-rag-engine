        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "set_id": {"type": "integer"},
                    "drawing_title": {"type": "string", "description": "Optional: filter by drawingTitle (document scope)"},
                    "drawing_name": {"type": "string", "description": "Optional: filter by drawingName (document scope)"},
                },
                "required": ["project_id"],
            },
        },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "section_title": {"type": "string", "description": "Optional: filter by sectionTitle (document scope)"},
                },
                "required": ["project_id"],
            },
        },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "limit": {"type": "integer", "default": 10},
                    "section_title": {"type": "string", "description": "Optional: filter by sectionTitle (document scope)"},
                    "pdf_name": {"type": "string", "description": "Optional: filter by pdfName (document scope)"},
                },
                "required": ["project_id", "search_text"],
            },
        },
