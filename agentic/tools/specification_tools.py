...
def search_specification_text(
    ...
    # Fix: project drawingTitle, drawingName, sectionText so the orchestrator's
    # _extract_source_documents can populate display_title / drawing_name /
    # drawing_title for the UI. Without these, source_documents come back with
    # empty display fields even though the underlying Mongo data has them.
    try:
